 ...
 * @author ricardorq85
 */
public class TendenciaProcesoFiltroFechaTendenciaFechaBaseDAO extends OracleTendenciaProcesoBuySellDAO {
	...
	protected String getSqlBase() {
		String sql = "WITH " + "	PARAMETROS AS (" + "		SELECT ? PERIODO," + "		(?) TIEMPO_TENDENCIA,"
				...
				+ "			COUNT(*) CANTIDAD, "
				+ "			(2+1*(PARAM.TIEMPO_TENDENCIA/60-WEEK_MINUTES(TRUNC(TEN.FECHA_TENDENCIA, 'HH24'),TRUNC(PARAM.FECHA_PROCESO, 'HH24'))/60)) MAYORQ_EXIGIDA,"
