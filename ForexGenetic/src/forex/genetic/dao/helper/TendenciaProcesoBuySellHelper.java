...
public class TendenciaProcesoBuySellHelper {
	...
	public static Regresion helpRegresion(ProcesoTendenciaBuySell procesoTendencia, SimpleRegression simpleRegressionProcessor) throws SQLException {
		Regresion regresion = null;
			...
			regresion.setR2(simpleRegressionProcessor.getR());
			regresion.setPendiente(simpleRegressionProcessor.getSlope());
