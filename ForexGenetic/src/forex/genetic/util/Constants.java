...
public class Constants {
	...
	public enum IndividuoType {
		...
		INITIAL, CROSSOVER, MUTATION, OPTIMIZED, INDICADOR_GANADOR
	}

	public enum PriceType {

		CLOSE, AVERAGE, COMPARE_CLOSE, COMPARE_AVERAGE
	}
	...
	public static OperationType getOperationType(String operationTypeName) {
		return ("SELL".equalsIgnoreCase(operationTypeName) ? Constants.OperationType.SELL
				: Constants.OperationType.BUY);
	}

	public enum FortalezaType {
		Pips, Stable, Embudo, Pattern, PatternAdvanced;
	}
