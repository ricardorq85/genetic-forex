...
public abstract class Interval<E> implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (this.lowInterval != other.lowInterval
				&& (this.lowInterval == null || !this.lowInterval.equals(other.lowInterval))) {
			return false;
		}
		if (this.highInterval != other.highInterval
				&& (this.highInterval == null || !this.highInterval.equals(other.highInterval))) {
			return false;
		}
		return true;
	}
