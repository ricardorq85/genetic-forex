...
public class Bollinger240IndicatorManager extends BollingerIndicatorManager {
    ...
    public String[] queryRangoOperacionIndicador() {
        ...
        s[0] = " MIN(DH.BOLLINGER_UPPER240-DH.BOLLINGER_LOWER240) INTERVALO_INFERIOR, MAX(DH.BOLLINGER_UPPER240-DH.BOLLINGER_LOWER240) INTERVALO_SUPERIOR, "
                + "  ROUND(AVG(DH.BOLLINGER_UPPER240-DH.BOLLINGER_LOWER240), 5) PROMEDIO, ";
        s[1] = " DH.BOLLINGER_UPPER240 IS NOT NULL AND DH.BOLLINGER_LOWER240 IS NOT NULL ";
        return s;
    }
