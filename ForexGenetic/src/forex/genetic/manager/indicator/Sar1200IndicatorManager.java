...
public class Sar1200IndicatorManager extends SarIndicatorManager {
    ...
    public String[] queryRangoOperacionIndicador() {
        ...
        s[0] = " MIN(DH.SAR1200-OPER.OPEN_PRICE) INTERVALO_INFERIOR, MAX(DH.SAR1200-OPER.OPEN_PRICE) INTERVALO_SUPERIOR, "
                + " ROUND(AVG(DH.SAR1200-OPER.OPEN_PRICE), 5) PROMEDIO, ";
        s[1] = " DH.SAR1200 IS NOT NULL ";
        return s;
    }
    ...
    public String[] queryPorcentajeCumplimientoIndicador() {
        ...
        s[0] = " ((DH.SAR1200-DH.LOW) BETWEEN ? AND ? "
                + "  OR (DH.SAR1200-DH.HIGH) BETWEEN ? AND ? ) ";
        return s;
    }    
