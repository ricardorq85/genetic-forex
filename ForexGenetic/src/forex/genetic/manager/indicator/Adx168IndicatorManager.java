...
public class Adx168IndicatorManager extends AdxIndicatorManager {
	...
	public String[] queryRangoOperacionIndicador() {
		...
		s[0] = "  MIN((DH.ADX_VALUE168*(DH.ADX_PLUS168-DH.ADX_MINUS168))) INTERVALO_INFERIOR, MAX((DH.ADX_VALUE168*(DH.ADX_PLUS168-DH.ADX_MINUS168))) INTERVALO_SUPERIOR, "
				+ "  ROUND(AVG((DH.ADX_VALUE168*(DH.ADX_PLUS168-DH.ADX_MINUS168))), 5) PROMEDIO, ";
		s[1] = " DH.ADX_VALUE168 IS NOT NULL AND DH.ADX_PLUS168 IS NOT NULL AND DH.ADX_MINUS168 IS NOT NULL ";
		return s;
	}
