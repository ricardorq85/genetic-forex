...
public class MomentumIndicatorManager extends IntervalIndicatorManager<Momentum> {
	...
	/*
	 * public Indicator optimize(Momentum individuo, Momentum
	 * optimizedIndividuo, Momentum indicator, Point point) { Momentum optimized
	 * = this.getIndicatorInstance(); double value = indicator.getMomentum();
