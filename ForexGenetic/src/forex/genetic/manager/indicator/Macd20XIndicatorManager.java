...
public class Macd20XIndicatorManager extends MacdIndicatorManager {
    ...
    public String[] queryRangoOperacionIndicador() {
        ...
        s[0] = " MIN(DH.MACD20X_VALUE+DH.MACD20X_SIGNAL) INTERVALO_INFERIOR, MAX(DH.MACD20X_VALUE+DH.MACD20X_SIGNAL) INTERVALO_SUPERIOR, "
                + "  ROUND(AVG(DH.MACD20X_VALUE+DH.MACD20X_SIGNAL), 5) PROMEDIO, ";
        s[1] = " DH.MACD20X_VALUE IS NOT NULL AND DH.MACD20X_SIGNAL IS NOT NULL ";
        return s;
    }
