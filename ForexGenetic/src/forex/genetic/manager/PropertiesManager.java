...
public class PropertiesManager {
	...
	private static String uriMongoDB = null;
	...
	public static Thread load() {
		t = new Thread() {
			...
			public void run() {
				...
				queryProcesarTendenciasValorProbable = PropertiesManager
						.getPropertyString(Constants.QUERY_PROCESAR_TENDENCIAS_VALOR_PROBABLE);
				queryProcesarTendenciasValorProbableBase = PropertiesManager
						.getPropertyString(Constants.QUERY_PROCESAR_TENDENCIAS_VALOR_PROBABLE_BASE);
				queryProcesarTendenciasValorProbableDetalle = PropertiesManager
						.getPropertyString(Constants.QUERY_PROCESAR_TENDENCIAS_VALOR_PROBABLE_DETALLE);
				...
				uriMongoDB = PropertiesManager.getPropertyString(Constants.URI_MONGODB);
			}
		};
		t.start();
		return t;
	...
	public static String getUriMongoDB() {
		return uriMongoDB;
	}
