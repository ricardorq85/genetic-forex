...
SELECT TPO.TIPO_TENDENCIA, TPO.CANTIDAD, TPO.CANTIDAD_FILTRADA, 
	TPO.PRECIO_CALCULADO, TPO.TAKE_PROFIT, TPO.LIMIT_APERTURA, TPO.VALOR_TEMPORAL,
	ABS(TPO.PRECIO_CALCULADO-TPO.TAKE_PROFIT)*100000 DIFF, TPO.ACTIVA,
	TPO.*
FROM TENDENCIA_PARA_OPERAR TPO --WHERE TIPO_TENDENCIA LIKE 'MEJOR_TENDENCIA'
WHERE ACTIVA=1 and 
TPO.FECHA_BASE>=TO_DATE('2019/01/15 04:58', 'YYYY/MM/DD HH24:MI')
--and tipo_operacion='BUY'
ORDER BY FECHA_BASE aSC,TIPO_OPERACION ASC, PERIODO ASC, TPO.ACTIVA ASC
--ORDER BY FECHA_BASE ASC
;

SELECT FACTOR_DATOS, DATPO.* FROM DATO_ADICIONAL_TPO DATPO
	WHERE FECHA_BASE>=TO_DATE('2019/01/15 04:58', 'YYYY/MM/DD HH24:MI') --AND FECHA_BASE<=TO_DATE('2017/07/04 00:00', 'YYYY/MM/DD HH24:MI') --AND DIFF_PRECIO_EXTREMO_SUPERIOR IS NOT NULL
