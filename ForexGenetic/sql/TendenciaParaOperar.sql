...
SELECT * FROM TENDENCIA_PARA_OPERAR TPO
WHERE TPO.ID_EJECUCION in ('1506183450729')
ORDER BY FECHA_BASE DESC, PERIODO DESC;

SELECT * FROM TENDENCIA_PARA_OPERAR TPO
WHERE TPO.FECHA_BASE>TO_DATE('2017.01.18 12:18', 'YYYY/MM/DD HH24:MI')
...
UPDATE TENDENCIA_PARA_OPERAR SET ACTIVA=1 WHERE PERIODO='EXTREMO_SINFILTRAR';
