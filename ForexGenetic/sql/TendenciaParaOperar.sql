SELECT TPO.TIPO_TENDENCIA, TPO.CANTIDAD, TPO.CANTIDAD_FILTRADA, TPO.*
...
SELECT TPO.TIPO_TENDENCIA, TPO.CANTIDAD, TPO.CANTIDAD_FILTRADA CANT_FILT, TPO.*
FROM TENDENCIA_PARA_OPERAR TPO
WHERE TPO.FECHA_BASE>=TO_DATE('2016/09/30 08:33', 'YYYY/MM/DD HH24:MI') --AND TPO.TIPO_OPERACION='SELL' --AND PERIODO NOT LIKE 'EXTREMO%'
...
SELECT FACTOR_DATOS, DATPO.* FROM DATO_ADICIONAL_TPO DATPO
	WHERE FECHA_BASE>=TO_DATE('2016/09/30 08:33', 'YYYY/MM/DD HH24:MI') --AND FECHA_BASE<=TO_DATE('2017/07/04 00:00', 'YYYY/MM/DD HH24:MI') --AND DIFF_PRECIO_EXTREMO_SUPERIOR IS NOT NULL
	--AND MAX_EXTREMO_SINFILTRAR IS NULL
ORDER BY FECHA_BASE ASC --ORDER BY ABS(DIFF_PRECIO_EXTREMO_SUPERIOR) ASC
;

SELECT fecha_base, FACTOR_DATOS, (1/FACTOR_DATOS), (1/0.1),
	DATPO.*
FROM DATO_ADICIONAL_TPO DATPO
where factor_datos>0;
