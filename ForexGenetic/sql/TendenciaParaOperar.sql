...
SELECT * FROM TENDENCIA_PARA_OPERAR TPO
WHERE TPO.FECHA_BASE>=TO_DATE('2017/07/13 00:21', 'YYYY/MM/DD HH24:MI')
...
SELECT * FROM DATO_ADICIONAL_TPO
WHERE FECHA_BASE>=TO_DATE('2017/07/13 00:21', 'YYYY/MM/DD HH24:MI')
...
SELECT TPO.*, DA.* FROM TENDENCIA_PARA_OPERAR TPO
