SELECT TPO.TIPO_TENDENCIA, TPO.CANTIDAD, TPO.CANTIDAD_FILTRADA, 
	TPO.PRECIO_CALCULADO, TPO.LIMIT_APERTURA,
	TPO.*
...
SELECT TPO.TIPO_TENDENCIA, TPO.PRECIO_CALCULADO, TPO.LIMIT_APERTURA, TPO.TAKE_PROFIT, TPO.STOP_LOSS, TPO.STOP_APERTURA,
	TPO.FECHA, TPO.*
FROM TENDENCIA_PARA_OPERAR TPO
WHERE TPO.FECHA_BASE>=TO_DATE('2017/07/31 18:25', 'YYYY/MM/DD HH24:MI') --AND TPO.TIPO_OPERACION='SELL' --AND PERIODO NOT LIKE 'EXTREMO%'
--AND ACTIVA=1
...
SELECT FACTOR_DATOS, DATPO.* FROM DATO_ADICIONAL_TPO DATPO
	WHERE FECHA_BASE>=TO_DATE('2017/07/31 18:25', 'YYYY/MM/DD HH24:MI') --AND FECHA_BASE<=TO_DATE('2017/07/04 00:00', 'YYYY/MM/DD HH24:MI') --AND DIFF_PRECIO_EXTREMO_SUPERIOR IS NOT NULL
