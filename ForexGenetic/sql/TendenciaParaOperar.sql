...
WHERE TPO.FECHA_BASE>=TO_DATE('2017/10/18 18:14', 'YYYY/MM/DD HH24:MI') --AND TPO.TIPO_OPERACION='SELL' --AND PERIODO NOT LIKE 'EXTREMO%'
--AND PERIODO NOT LIKE '%FILTRAR' --AND TPO.ACTIVA=1 --AND TPO.FECHA>SYSDATE-0.1
ORDER BY --FECHA ASC,
FECHA_BASE aSC, ACTIVA DESC, TIPO_OPERACION ASC, PERIODO ASC;

SELECT * FROM DATO_ADICIONAL_TPO
	WHERE FECHA_BASE>=TO_DATE('2017/10/18 18:14', 'YYYY/MM/DD HH24:MI') --AND FECHA_BASE<=TO_DATE('2017/07/04 00:00', 'YYYY/MM/DD HH24:MI') --AND DIFF_PRECIO_EXTREMO_SUPERIOR IS NOT NULL
