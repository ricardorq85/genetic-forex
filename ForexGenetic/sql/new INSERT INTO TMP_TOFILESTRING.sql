...
INSERT INTO TMP_TOFILESTRING2 (ID_INDIVIDUO, CRITERIO_ORDER1, CRITERIO_ORDER2, VIGENCIA1, VIGENCIA2)
  SELECT PRE_TFS.ID_INDIVIDUO, 
	ROUND((MIN(PRE_TFS.PIPS_SEMANA)+MIN(PRE_TFS.PIPS_MES)+MIN(PRE_TFS.PIPS_ANYO)+MIN(PRE_TFS.PIPS_TOTALES))/3), 
	MIN(PRE_TFS.PIPS_TOTALES),
