...
SELECT IC.OPEN_INFERIOR_RSI, IC.OPEN_SUPERIOR_RSI, IC.*
FROM INDIVIDUO_INDICADORES IC 
WHERE ID LIKE '1476485020741.%'
--WHERE ID IN('1476485020741.104', '1476485020741.204')
ORDER BY IC.OPEN_INFERIOR_RSI ASC, ID ASC
;

SELECT * FROM INDIVIDUO_INDICADORES IC;

SELECT COUNT(*) FROM INDICADOR_INDIVIDUO;

SELECT * FROM INDIVIDUO 
WHERE ID = '1476450387124.1';

SELECT II.* FROM FOREX.INDICADOR_INDIVIDUO II
WHERE II.ID_INDIVIDUO like '1476477665179.%'
ORDER BY --TIPO DESC, 
ID_INDICADOR, ID_INDIVIDUO
;
