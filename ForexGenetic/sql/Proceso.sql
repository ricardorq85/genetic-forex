...
WHERE IND.ID LIKE '1518001713538.140159'
ORDER BY P.FECHA_PROCESO DESC;

--UPDATE PROCESO P SET FECHA_HISTORICO=TO_DATE('2009/05/07 16:24', 'YYYY/MM/DD HH24:MI')
--WHERE P.ID_INDIVIDUO='1518001713538.140159';
