...
--SELECT (TEN.CANTIDAD-TEN.MAYORQ_EXIGIDA) DIFFCANT, TEN.*, ROUND(TEN.CANTIDAD/PROM.AVGCANTIDAD,2) FACTORCANTIDAD FROM PARAMETROS PARAM, PROMEDIOS PROM, TENDENCIA_CALCULADA TEN	ORDER BY TEN.FECHA_TENDENCIA DESC;
