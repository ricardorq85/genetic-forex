...
--WHERE TRUNC(TEN.FECHA_BASE,'HH24')=TO_DATE('2017/05/19 01:00', 'YYYY:MM:DD HH24:MI') AND TRUNC(TEN.FECHA_TENDENCIA,'HH24')=TO_DATE('2017/05/29 11:00', 'YYYY:MM:DD HH24:MI') 
--ORDER BY FECHA DESC;
--ORDER BY TEN.FECHA_TENDENCIA ASC;
--ORDER BY TEN.PRECIO_CALCULADO deSC;
