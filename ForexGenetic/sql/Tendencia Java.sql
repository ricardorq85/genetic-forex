...
--SELECT PARAM.PERIODO PERIODO, TEN.*, ROUND(TEN.CANTIDAD/PROM.AVGCANTIDAD,2) FACTORCANTIDAD FROM PARAMETROS PARAM, PROMEDIOS PROM, TENDENCIA_CALCULADA TEN	ORDER BY TEN.FECHA_TENDENCIA ASC;
SELECT PARAM.PERIODO PERIODO, REG.*  FROM PARAMETROS PARAM, REGRESION REG
;

WITH 
PARAMETROS AS (
		SELECT 'XD' PERIODO, (1440*3) TIEMPO_TENDENCIA,
		TO_DATE(
		'
		2017/04/03 13:06
		'
