DECLARE
  ...
  CURSOR C_INDIVIDUOS(FECHA_OPERACIONES IN DATE) IS
    ...
    --AND (IND.ID NOT IN (SELECT DISTINCT PRO.ID_INDIVIDUO FROM PROCESO PRO) OR (IND.ID='1329927210938.1525'))
...
--    IF (REG_INDIVIDUO.ID='1329927210938.1525') THEN
--      FECHA_OPERACION := TO_DATE('2010/02/24 15:02','YYYY/MM/DD HH24:MI');
--    ELSE
--      FECHA_OPERACION := FECHA_INICIAL;
--    END IF;
