...
WHERE SEM.ID_INDIVIDUO='1329927210938.4228'
AND FECHA_SEMANA>=TO_DATE('20120901', 'YYYYMMDD')
ORDER BY FECHA_SEMANA ASC
;

SELECT * FROM OPERACIONES_ACUM_SEMANA_MES MES
WHERE MES.ID_INDIVIDUO='1329927210938.4228'
AND FECHA_SEMANA>=TO_DATE('20120801', 'YYYYMMDD')
ORDER BY FECHA_SEMANA ASC
;
