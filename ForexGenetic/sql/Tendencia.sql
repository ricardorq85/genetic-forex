...
AND T.FECHA_BASE=TO_DATE('2017.01.17 02:15', 'YYYY/MM/DD HH24:MI')
...
SELECT MIN(FECHA_BASE) FROM TENDENCIA 
WHERE FECHA_BASE>TO_DATE('2017/04/24 11:13', 'YYYY/MM/DD HH24:MI')
;
