...
ORDER BY T.FECHA_BASE DESC, T.TIPO_TENDENCIA DESC
...
SELECT * FROM TENDENCIA T1
WHERE TIPO_TENDENCIA='BUY_SELL_20170125';

SELECT * FROM TENDENCIA T1
WHERE T1.ID_INDIVIDUO='1483900498799.463'
...
WHERE ID_INDIVIDUO ='1477365411387.9040'
...
SELECT TO_CHAR(T.FECHA_APERTURA, 'YYYY'), COUNT(*)
FROM TENDENCIA T
GROUP BY TO_CHAR(T.FECHA_APERTURA, 'YYYY')
ORDER BY TO_CHAR(T.FECHA_APERTURA, 'YYYY') DESC;
