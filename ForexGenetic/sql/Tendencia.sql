...
SELECT TO_CHAR(TEN.FECHA_BASE, 'YYYYMMDD'), COUNT(*), 
	MIN(TEN.FECHA_BASE) MINFEBASE, MAX(TEN.FECHA_BASE) MAXFEBASE, 
	MAX(TEN.FECHA) MAXFE,
	SUM(TEN.PIPS) PIPS
...
SELECT TRUNC(TEN.FECHA_BASE), COUNT(*) FROM TENDENCIA TEN 
	 WHERE TEN.FECHA_BASE 
		BETWEEN to_date('2017/05/29 22:10', 'YYYY/MM/DD HH24:MI') AND to_date('2017/06/29 22:10', 'YYYY/MM/DD HH24:MI')
