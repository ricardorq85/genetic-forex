...
WHERE T.TIPO_TENDENCIA='BUY_SELL_20170204'
...
FROM TENDENCIA TEN
WHERE TEN.TIPO_TENDENCIA='BUY_SELL_20170201'
AND TEN.FECHA_BASE<=TO_DATE('2017/02/03 11:53', 'YYYY/MM/DD HH24:MI') 
AND TEN.FECHA_TENDENCIA>TO_DATE('2017/02/03 11:53', 'YYYY/MM/DD HH24:MI')
...
SELECT * FROM TENDENCIA T1
WHERE T1.ID_INDIVIDUO='1484511934277.2009'
...
SELECT TEN1.*, TEN2.* FROM TENDENCIA TEN1 INNER JOIN TENDENCIA TEN2
	ON TEN1.ID_INDIVIDUO=TEN2.ID_INDIVIDUO
WHERE TEN1.FECHA_BASE=TO_DATE('2017/01/27 23:58', 'YYYY/MM/DD HH24:MI')
	AND TEN2.FECHA_BASE=TO_DATE('2017/01/27 22:58', 'YYYY/MM/DD HH24:MI')	
;