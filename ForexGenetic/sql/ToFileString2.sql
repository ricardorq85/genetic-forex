...
SELECT 'EstrategiaId='||IND.ID||',VigenciaLower='||TO_CHAR(TMP.FECHA_APERTURA-1/24/60, 'YYYY.MM.DD HH24:MI')||',VigenciaHigher='||TO_CHAR(TMP.FECHA_APERTURA+30, 'YYYY.MM.DD HH24:MI')||','||
...
FROM    INDICADOR_INDIVIDUO II_OPEN_MA, INDICADOR_INDIVIDUO II_CLOSE_MA,
        ...
        INDIVIDUO IND, (SELECT MIN(ID_INDIVIDUO) ID_IND, FECHA_APERTURA FROM TMP_TABLE
          GROUP BY FECHA_APERTURA) TMP
      ...
      AND IND.ID = TMP.ID_IND
      ORDER BY TMP.FECHA_APERTURA ASC
;
