...
SELECT AC2.ID_INDIVIDUO, AC2.FECHA_SEMANA, AC2.PIPS PIPS, AC2.CANTIDAD, AC2.FECHA_HISTORICO,
  AC2.R_COUNT, AC2.R2, AC2.PENDIENTE, AC2.INTERCEPCION
FROM (
  SELECT AC.ID_INDIVIDUO, AC.FECHA_SEMANA, AC.FECHA_CIERRE, AC.PIPS, AC.CANTIDAD, AC.MINFE, AC.MAXFE, AC.FECHA_HISTORICO,
    REGR_COUNT(AC.PIPS_REGR, AC.FECHA_CIERRE-AC.FECHA_HISTORICO)
  ...
  FROM (
    SELECT MAX(OPER.ID_INDIVIDUO) OVER () ID_INDIVIDUO, SEMANAS.FECHA_SEMANA  FECHA_SEMANA, 
      NVL(OPER.FECHA_CIERRE,SEMANAS.FECHA_SEMANA) FECHA_CIERRE,
      ...
      NVL(SUM(OPER.PIPS) OVER (ORDER BY OPER.FECHA_CIERRE ASC RANGE BETWEEN INTERVAL '12' MONTH PRECEDING AND CURRENT ROW),0) PIPS_REGR,
      ...
      COUNT(OPER.PIPS) OVER (ORDER BY OPER.FECHA_CIERRE ASC RANGE BETWEEN INTERVAL '12' MONTH PRECEDING AND CURRENT ROW) CANTIDAD_REGR,
