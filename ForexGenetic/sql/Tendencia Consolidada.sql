...
FROM TENDENCIA TEN WHERE TEN.TIPO_TENDENCIA IN ('BUY_SELL_20170204', 'BUY_SELL_20170131-3' ,'BUY_SELL_20170125')
AND TEN.FECHA_BASE<=TO_DATE('2017/01/27 23:58','YYYY/MM/DD HH24:MI')
AND TEN.FECHA_TENDENCIA>TO_DATE('2017/01/27 23:57','YYYY/MM/DD HH24:MI')
