...
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=NULL;
UPDATE TENDENCIA_PARA_OPERAR TPO SET VALOR_TEMPORAL=LIMIT_APERTURA;
UPDATE TENDENCIA_PARA_OPERAR TPO SET LIMIT_APERTURA=PRECIO_CALCULADO;
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=1, PRECIO_CALCULADO=PRECIO_CALCULADO+200/100000
WHERE TPO.TIPO_OPERACION='BUY' AND ACTIVA=1;
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=1, PRECIO_CALCULADO=PRECIO_CALCULADO-200/100000 
WHERE TPO.TIPO_OPERACION='SELL' AND ACTIVA=1;
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=1, PRECIO_CALCULADO=PRECIO_CALCULADO+200/100000 
WHERE TPO.TIPO_OPERACION='BUY' AND ACTIVA=0;
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=1, PRECIO_CALCULADO=PRECIO_CALCULADO-200/100000 
WHERE TPO.TIPO_OPERACION='SELL' AND ACTIVA=0;
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=1,UPDATE_TEMPORAL=2 WHERE ACTIVA=0 AND UPDATE_TEMPORAL=1;
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=0 WHERE TIPO_TENDENCIA LIKE 'EXTREMO%';
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=0 WHERE UPDATE_TEMPORAL=2 AND ACTIVA=1;
...
UPDATE TENDENCIA_PARA_OPERAR TPO SET LIMIT_APERTURA=VALOR_TEMPORAL;

--UPDATE TENDENCIA_PARA_OPERAR TPO SET VALOR_TEMPORAL=LIMIT_APERTURA; 
--UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=NULL; 


SELECT * FROM TENDENCIA_PARA_OPERAR TPO WHERE TIPO_OPERACION='BUY' AND PRECIO_CALCULADO<STOP_LOSS OR PRECIO_CALCULADO>TAKE_PROFIT;
SELECT * FROM TENDENCIA_PARA_OPERAR TPO WHERE TIPO_OPERACION='SELL' AND PRECIO_CALCULADO>STOP_LOSS OR PRECIO_CALCULADO<TAKE_PROFIT;

UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=NULL; 
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=ACTIVA; 
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=1;
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=0 WHERE PERIODO='EXTEXT';
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=0 WHERE LIMIT_APERTURA IS NULL;

UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=UPDATE_TEMPORAL;
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=NULL; 
UPDATE TENDENCIA_PARA_OPERAR TPO SET UPDATE_TEMPORAL=ACTIVA; 
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=0 WHERE LIMIT_APERTURA IS NULL;
UPDATE TENDENCIA_PARA_OPERAR TPO SET ACTIVA=UPDATE_TEMPORAL;
