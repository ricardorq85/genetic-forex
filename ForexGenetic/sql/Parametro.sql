UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/12/08 22:59' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='1' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='290' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='251' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/07/13 11:50' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
