UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2016/10/01 00:00' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='9' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='16' WHERE NOMBRE='NUM_TENDENCIA_X_CANTIDAD';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='330' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='111' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';
	
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2016/08/01 00:00' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2016/12/01 00:00' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='36' WHERE NOMBRE='STEP_PROCESAR_TENDENCIA';
