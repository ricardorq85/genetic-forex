UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/07/21 03:00' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='6' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='135' WHERE NOMBRE='NUM_TENDENCIA_X_CANTIDAD';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='270' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='171' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/03/01 00:00' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/08/01 00:00' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='37' WHERE NOMBRE='STEP_PROCESAR_TENDENCIA';
...
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='5' WHERE NOMBRE='MESES_RANGOOPERACIONINDICADOR';
...
--DELETE FROM PARAMETRO WHERE NOMBRE='DELETE_TENDENCIA_PARA_OPERAR';