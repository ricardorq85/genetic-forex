UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/12/01 13:59' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='0' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='380' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='261' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='TRUE' WHERE NOMBRE='DELETE_TENDENCIA_PARA_OPERAR';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/11/20 00:00' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/11/29 16:30' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
...
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/11/01 00:00' WHERE NOMBRE='FECHA_INICIO_EXPORTACION';
