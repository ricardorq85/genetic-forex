UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/07/08 01:15' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='5' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='60' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='431' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='TRUE' WHERE NOMBRE='DELETE_TENDENCIA_PARA_OPERAR';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/04/03 00:04' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/07/07 23:59' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
