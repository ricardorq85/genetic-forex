UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/12/05 23:38' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='10' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='20' WHERE NOMBRE='NUM_TENDENCIA_X_CANTIDAD';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='195' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='250' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/10/16 17:00' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/12/01 00:00' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
...
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2018/01/01 00:00' WHERE NOMBRE='FECHA_MINIMA_CREAR_INDIVIDUO';
