...
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2013/12/31 23:59' WHERE NOMBRE='FECHA_INDIVIDUO_PERIODO';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2016/09/09 23:58' WHERE NOMBRE='FECHA_FIN_INDIVIDUO_PERIODO';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='12' WHERE NOMBRE='MESES_INDIVIDUO_PERIODO';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2016/07/01 00:00' WHERE NOMBRE='FECHA_MINIMA_CREAR_INDIVIDUO';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2016/09/30 23:59' WHERE NOMBRE='FECHA_MAXIMA_CREAR_INDIVIDUO';
