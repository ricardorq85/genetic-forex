...
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/06/29 22:10' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='1440' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='120' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='TRUE' WHERE NOMBRE='DELETE_TENDENCIA_PARA_OPERAR';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/02/01 00:00' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017.02.20 00:00' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
