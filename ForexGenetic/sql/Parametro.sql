UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/07/07 08:39' WHERE NOMBRE='FECHA_INICIO_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='4' WHERE NOMBRE='MESES_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='60' WHERE NOMBRE='STEP_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='351' WHERE NOMBRE='INDIVIDUOS_X_TENDENCIA';

UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='TRUE' WHERE NOMBRE='DELETE_TENDENCIA_PARA_OPERAR';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/10/17 16:59' WHERE NOMBRE='FECHA_INICIO_PROCESAR_TENDENCIA';
UPDATE PARAMETRO SET FECHA=SYSDATE, VALOR='2017/10/18 02:59' WHERE NOMBRE='FECHA_FIN_PROCESAR_TENDENCIA';
