SELECT PTFS.ID_INDIVIDUO, PTFS.FECHA_SEMANA, EOP.ID, PTFS.ROWID PTFS_ROWID, EOP.ROWID EOP_ROWID, EOP.*
  FROM PREVIO_TOFILESTRING PTFS, ESTRATEGIA_OPERACION_PERIODO EOP
		WHERE  --PTFS.PIPS_SEMANA IS NOT NULL AND PTFS.PIPS_SEMANA>0 AND
			...
			AND PTFS.R2_MES>EOP.FILTRO_R2_MES 
			...
			AND PTFS.PENDIENTE_MES>EOP.FILTRO_PENDIENTE_MES 
	...
	AND PTFS.FECHA_SEMANA>TO_DATE('20160117','YYYYMMDD')
--	AND EOP.ID=1178206 --1169749
	AND PTFS.ID_INDIVIDUO='1477365411387.4766'
	;
