SELECT IND.ID, DH1_OPEN.FECHA OPEN_FECHA, MIN(DH1_CLOSE.FECHA) CLOSE_FECHA 
  ...
  AND (
      (PROCESS_OPEN(II_OPEN_MA.INTERVALO_INFERIOR, II_OPEN_MA.INTERVALO_SUPERIOR, DH1_OPEN.AVERAGE,(DH1_OPEN.OPEN+DH1_OPEN.CLOSE+DH1_OPEN.HIGH+DH1_OPEN.LOW)/4)>0)
  ...
  --AND DH1_OPEN.FECHA >= to_date('2008/06/01 00','YYYY/MM/DD HH24') AND DH1_OPEN.FECHA < to_date('2009/06/02 01','YYYY/MM/DD HH24')
  --AND DH1_OPEN.FECHA = TO_DATE('2008/05/06 08:45','YYYY/MM/DD HH24:MI')
  --AND DH1_CLOSE.FECHA = TO_DATE('2008/05/06 08:45', 'YYYY/MM/DD HH24:MI')
  --AND ROWNUM < 5
  AND IND.ID='1321917584436.567'
