...
WITH TIEMPO_TENDENCIA AS (
	SELECT (120) T2H, (24*0.25/24)*24*60 T6H, (24*0.5/24)*24*60 T12H, (24*1/24)*24*60 T1D,
		...
		0.5 R2_MINIMO, 0.0 PENDIENTE_MINIMA, 15 MINPIPS,
		...
		(24*2/24)*24*60  TIEMPO_PROYECCION, (24*5/24)*24*60 TIEMPO_REGRESION, (24*2/24)*24*60 TIEMPO_MAX_MIN,
		--V_DATE FECHA_PROCESO,
		TO_DATE('2017.01.24 07:59', 'YYYY/MM/DD HH24:MI') FECHA_PROCESO,
...
--SELECT * FROM PONDERADO POND ORDER BY POND.FECHA_TENDENCIA ASC	;
FETEMPORAL AS (
	SELECT TO_DATE('20170210 11:00','YYYYMMDD HH24:MI') FE FROM DUAL
	UNION ALL SELECT TO_DATE('20170213 05:00','YYYYMMDD HH24:MI') FE FROM DUAL
),
REGRESION_6H AS (SELECT '6H' PERIODO, ROUND(REGR_R2(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) R2,
		...
		MIN(TEN.FECHA_TENDENCIA) MINFETENDENCIA, MAX(TEN.FECHA_TENDENCIA) MAXFETENDENCIA
		FROM TIEMPO_TENDENCIA TT, PONDERADO TEN, TENDENCIA_6H TEN_PARCIAL
		WHERE TEN.FECHA_TENDENCIA=TEN_PARCIAL.FECHA_TENDENCIA
...
REGRESION_12H AS (SELECT '12H' PERIODO, ROUND(REGR_R2(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) R2,
		ROUND(REGR_SLOPE(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) PENDIENTE,
		MIN(TEN.FECHA_TENDENCIA) MINFETENDENCIA, MAX(TEN.FECHA_TENDENCIA) MAXFETENDENCIA
		FROM TIEMPO_TENDENCIA TT, PONDERADO TEN, TENDENCIA_12H TEN_PARCIAL
		WHERE TEN.FECHA_TENDENCIA=TEN_PARCIAL.FECHA_TENDENCIA
...
REGRESION_1D AS (SELECT '1D' PERIODO, ROUND(REGR_R2(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) R2,
		ROUND(REGR_SLOPE(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) PENDIENTE,
		MIN(TEN.FECHA_TENDENCIA) MINFETENDENCIA, MAX(TEN.FECHA_TENDENCIA) MAXFETENDENCIA
		FROM TIEMPO_TENDENCIA TT, PONDERADO TEN, TENDENCIA_1D TEN_PARCIAL
		WHERE TEN.FECHA_TENDENCIA=TEN_PARCIAL.FECHA_TENDENCIA
...
REGRESION_2D AS (SELECT '2D' PERIODO, ROUND(REGR_R2(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) R2,
		ROUND(REGR_SLOPE(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) PENDIENTE,
		MIN(TEN.FECHA_TENDENCIA) MINFETENDENCIA, MAX(TEN.FECHA_TENDENCIA) MAXFETENDENCIA
		FROM TIEMPO_TENDENCIA TT, PONDERADO TEN, TENDENCIA_2D TEN_PARCIAL
		WHERE TEN.FECHA_TENDENCIA=TEN_PARCIAL.FECHA_TENDENCIA
...
REGRESION_3D AS (SELECT '3D' PERIODO, ROUND(REGR_R2(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) R2,
		ROUND(REGR_SLOPE(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) PENDIENTE,
		MIN(TEN.FECHA_TENDENCIA) MINFETENDENCIA, MAX(TEN.FECHA_TENDENCIA) MAXFETENDENCIA
		FROM TIEMPO_TENDENCIA TT, PONDERADO TEN, TENDENCIA_3D TEN_PARCIAL
		WHERE TEN.FECHA_TENDENCIA=TEN_PARCIAL.FECHA_TENDENCIA
...
REGRESION_5D AS (SELECT '5D' PERIODO, ROUND(REGR_R2(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) R2,
	ROUND(REGR_SLOPE(TEN.PRECIO_CALCULADO, TEN.FECHA_TENDENCIA-TT.FECHA_PROCESO),5) PENDIENTE,
	MIN(TEN.FECHA_TENDENCIA) MINFETENDENCIA, MAX(TEN.FECHA_TENDENCIA) MAXFETENDENCIA
		FROM TIEMPO_TENDENCIA TT, PONDERADO TEN, TENDENCIA_5D TEN_PARCIAL
		WHERE TEN.FECHA_TENDENCIA=TEN_PARCIAL.FECHA_TENDENCIA
...
--SELECT * FROM REGRESION_12H
--SELECT * FROM REGRESION_5D
SELECT * FROM REGRESIONES
;
...
--SELECT * FROM REGRESION_6H
--SELECT * FROM VALORES_TENDENCIA
--SELECT * FROM OPERAR
--SELECT * FROM OPERAR_BUY
--SELECT * FROM MAX_MIN_X_REGRESION
;
