...
FROM PREVIO_TOFILESTRING PTFS
  ...
  --AND PTFSexce.R_COUNT_SEMANA>2 AND PTFS.R_COUNT_MES>PTFS.R_COUNT_SEMANA AND PTFS.R_COUNT_ANYO>PTFS.R_COUNT_MES AND PTFS.R_COUNT_CONSOL>PTFS.R_COUNT_ANYO  
  AND PTFS.R2_CONSOL>0.1 AND PTFS.R2_ANYO>=PTFS.R2_CONSOL AND PTFS.R2_MES>=PTFS.R2_ANYO AND PTFS.R2_SEMANA>=PTFS.R2_MES
  --AND PTFS.ID_INDIVIDUO='1454889600000.50'
...
WHERE OPER.ID_INDIVIDUO LIKE '1454889600000.50'
...
WHERE OPER.ID_INDIVIDUO='1454889600000.50'
