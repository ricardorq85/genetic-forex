...
WHERE OPER.ID_INDIVIDUO LIKE  '1477365411387.874'
...
WHERE OPER.ID_INDIVIDUO LIKE '1477365411387.13043'
...
WHERE OPER.ID_INDIVIDUO='1477365411387.13043'
...
WHERE OPER.ID_INDIVIDUO IN ('1477365411387.13043')
--AND FECHA_SEMANA>=TO_DATE('20160713', 'YYYYMMDD')
ORDER BY FECHA_SEMANA DESC
;
