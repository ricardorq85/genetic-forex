...
SELECT TRUNC((FECHA_CIERRE),'IW'), 
  ROUND(OPER.FECHA_CIERRE-TO_DATE('2016/09/09 23:58', 'YYYY/MM/DD HH24:MI'),2) DIFF,
  OPER.* FROM OPERACION OPER
WHERE OPER.ID_INDIVIDUO IN ('1461280102688.61')
--AND OPER.FECHA_CIERRE>=TO_DATE('20110101','YYYYMMDD')
...
SELECT ID_INDIVIDUO, TO_CHAR(FECHA_CIERRE, 'YYYY') FE, COUNT(*), SUM(PIPS)
 FROM FOREX.OPERACION OPER
WHERE 
ID_INDIVIDUO LIKE '1463541693654.6069'
AND FECHA_CIERRE IS NOT NULL
