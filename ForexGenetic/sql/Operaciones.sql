...
SELECT OPER.ID_INDIVIDUO, OPER.FECHA_APERTURA, OPER.FECHA_CIERRE, OPER.OPEN_PRICE, OPER.SPREAD, 
				...
				AND OPER.ID_INDIVIDUO in('1454889600000.1019','1477365411387.9040',
				'1454196071797.3183','1484511934277.1534','1484511934277.509','1454196071797.2662',
				'1477365411387.10104','1477365411387.1159')
				;
...
WHERE OPER.ID_INDIVIDUO LIKE '1518001713538.140159'
--AND OPER.FECHA_APERTURA>=TO_DATE('20161205','YYYYMMDD')
ORDER BY FECHA_APERTURA DESC;
...
SUM(PIPS), COUNT(*) 
FROM OPERACION OPER
WHERE OPER.FECHA_APERTURA>=TO_DATE('20170401','YYYYMMDD')
