...
SELECT OPER.ID_INDIVIDUO, TRUNC((FECHA_CIERRE),'IW'), OPER.FECHA_CIERRE,
  ROUND(OPER.FECHA_CIERRE-TO_DATE('2016/09/23 23:58', 'YYYY/MM/DD HH24:MI'),2) DIFF, OPER.PIPS,
  OPER.* FROM OPERACION OPER
WHERE OPER.ID_INDIVIDUO LIKE '1476746523125.1401'
