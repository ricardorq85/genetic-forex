...
WHERE OPER.ID_INDIVIDUO='1462763219878.287'
--AND OPER.FECHA_APERTURA>=TO_DATE('20160510','YYYYMMDD')
ORDER BY FECHA_APERTURA DESC;

SELECT ID_INDIVIDUO, COUNT(*), SUM(PIPS)
 FROM FOREX.OPERACION OPER
WHERE OPER.ID_INDIVIDUO IN ('1460948821579.1043')
--AND TO_CHAR(OPER.FECHA_CIERRE, 'YYYYMM')='201411'
AND OPER.FECHA_CIERRE>=TO_DATE('20160420','YYYYMMDD')
