...
public class Fortaleza implements Comparable<Fortaleza>, Serializable, Cloneable {
     ...
     *
     */
    public Fortaleza(FortalezaType type, int presentNumberPoblacion) {
        ...
        setPresentNumberPoblacion(presentNumberPoblacion);
    ...
    public Fortaleza clone() {
        ...
        try {
            ...
            f = new Fortaleza(this.type, this.presentNumberPoblacion);
        }
    ...
    public Fortaleza calculateDifference(Fortaleza f2) {
        Fortaleza f = new Fortaleza(this.type, this.presentNumberPoblacion);;
    ...
    public double calculate() {
        return this.calculate(0.0D, this.type);
    }
     ...
     * @return
     */
    public double calculate(double otherValue, FortalezaType type) {
