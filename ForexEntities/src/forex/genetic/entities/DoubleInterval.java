...
public class DoubleInterval extends Interval<Double> {
    ...
    private String operationType = "SELL";
    /**
     *
     */
     ...
     * @param name
     */
    public DoubleInterval(String name, String operationType) {
        super(name);
    ...
    public String toString() {
        ...
        buffer.append(this.operationType).append(this.name).append("Lower=").append(this.lowInterval * 100.0).append(",");
        buffer.append(this.operationType).append(this.name).append("Higher=").append(this.highInterval * 100.0);
