...
public class Constants {
    ...
    public static final int INITIAL_INDIVIDUOS = 300;
    ...
    public static final int INITIAL_POBLACION_COUNTER = 1;
    public static final int POBLACION_COUNTER = 12;
    ...
    public static final int MIN_TP = 20;
    public static final int MAX_TP = 1000;
    public static final int MIN_SL = 20;
