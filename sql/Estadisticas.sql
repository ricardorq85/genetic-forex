SELECT * FROM DETALLE_ESTADISTICAS WHERE ID_INDIVIDUO IN (
--'1331600380960.14951'
'1341461435364.12659'
);

SELECT SUM(PIPS) FROM OPERACION OPER GROUP BY OPER.ID_INDIVIDUO;
...
SELECT * FROM DETALLE_ESTADISTICAS DEST
...
WHERE PIPS_NEGATIVOS=0 AND PROC.FECHA_HISTORICO>TO_DATE('2012','YYYY') AND TOTAL_CANT>1
